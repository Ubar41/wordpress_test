...
Added: Submit Form WP error handler.
Fixed: Widget ID.
...
V2.2.4
New: Added automatic update the theme via Purchase Code and Personal Token key.
...
09/19/2015 V2.2.2
Updated plugin: WPbakery 4.7.1.1
...
New: Video Embed & Thumbnail Generator (https://wordpress.org/plugins/video-embed-thumbnail-generator/) compatible.
Updated Files: 
...
08/21/2014 V1.3
Added: Multiple videos, now you can add more than 1 video (un-limit), example http://videotube.marstheme.com/video/best-trance-music-2014/
...
Added: Columns option in archive/category/author page through "mars_layout_columns" filter, example for how to use the filter at http://themeforest.net/item/videotube-a-responsive-video-wordpress-theme/7214445/faqs/21232
